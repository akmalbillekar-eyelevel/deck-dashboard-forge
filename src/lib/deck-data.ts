...
export const slideMeta: SlideMeta[] = [
  ...
  { number: "10", title: "Inter-School League — Opportunity", notes: "This is the player pipeline for the entire ecosystem. Unlocks education + FMCG + CSR sponsors that won't touch pro sports." },
